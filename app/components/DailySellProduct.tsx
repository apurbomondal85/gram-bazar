    ...
    return (
        <Box className="group grid grid-cols-2 h-[240px] w-full" sx={{ bgcolor: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0px 0px 2px 1px rgba(0,0,0,0.3)' }}>
            <Box sx={{ position: 'relative', overflow: 'hidden' }}>
                ...
                <Image src={veg} alt="Product" className="w-full h-full" placeholder="blur" />
            ...
            <Box sx={{ padding: '16px' }} className="space-y-2">
                <Link href=''><Typography variant="h3" className="text-xl font-medium">Organic Green Cauliflower</Typography></Link>
                <p><span className="text-color-gray font-medium line-through">$22.00</span> <span className="text-secondary font-medium ms-2">$19.99</span></p>
